...
function renderFatalErrorPage(Throwable $e, string $toolLabel, string $toolVersion, string $productName): void
{
    ...
    $version = htmlspecialchars($toolVersion);
    $toolLabelEsc = htmlspecialchars($toolLabel);
...
<head>
    ...
    <title>Error — {$toolLabelEsc}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div>
                    ...
                    <p>The {$toolLabelEsc} encountered an unhandled exception and could not continue.</p>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <div>{$toolLabelEsc} v{$version} &mdash; <a href="https://support.powerphpscripts.com" target="_blank" rel="noopener noreferrer" style="color:#334155;">support.powerphpscripts.com</a></div>
        </div>
    </div>
